  ...
  return (
    <div className="bg-[#050508] text-white min-h-screen pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto text-center mb-24">
        <h2 className="text-[#b8ff3c] font-mono text-xs tracking-widest uppercase mb-4">The Relic Group</h2>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center bg-white/[0.02] p-12 rounded-3xl border border-white/5">
        <div className="space-y-6">
          ...
          <p className="text-white/60 leading-relaxed text-lg">
            ...
            honest people. I built the <strong>Relic Ecosystem</strong> to fix the foundation of our economy. 
          ...
          <div>
            ...
            <p className="text-[#b8ff3c] font-mono text-xs uppercase tracking-tighter">Founder & CEO, Relic Group</p>
          </div>
        </div>
