...
export default function Pricing() {
  return (
    <div className="bg-[#050508] text-white min-h-screen pt-40 px-6 text-center">
      ...
      <div className="max-w-md mx-auto bg-white/[0.02] border border-white/10 p-10 rounded-3xl">
        ...
        <button className="w-full bg-[#D4AF37] text-black py-4 rounded-full font-bold">Start Free Trial</button>
      </div>
    </div>
  );
}
