...
export default function GlobalFooter() {
  ...
  if (!mounted) return <div className="min-h-[400px] bg-syntry-obsidian min-h-screen" />; // Safety Ghost Shell

  return (
    <footer className="bg-syntry-obsidian pt-32 pb-16 px-6 overflow-hidden border-t border-white/5 relative z-10">
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-16 lg:gap-12 mb-24 text-center md:text-left">
          
          {/* Column 1: Company */}
          <div className="space-y-8">
            <h4 className="text-syntry-teal-600 font-sans text-[11px] uppercase tracking-[4px] font-medium">Company</h4>
            <ul className="flex flex-col gap-5">
              {footerLinks.company.map((link) => (
                <li key={link.label}>
                  <a href={link.href} className="text-[10px] font-sans tracking-[2px] text-white/30 hover:text-syntry-teal-600 transition-colors uppercase font-medium">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          {/* Column 2: Product */}
          <div className="space-y-8">
            <h4 className="text-syntry-teal-600 font-sans text-[11px] uppercase tracking-[4px] font-medium">Product</h4>
            <ul className="flex flex-col gap-5">
          ...
          {/* Column 3: For You */}
          <div className="space-y-8">
            <h4 className="text-syntry-teal-600 font-sans text-[11px] uppercase tracking-[4px] font-medium">For You</h4>
            <ul className="flex flex-col gap-5">
          ...
          {/* Column 4: Resources */}
          <div className="space-y-8">
            <h4 className="text-syntry-teal-600 font-sans text-[11px] uppercase tracking-[4px] font-medium">Resources</h4>
            <ul className="flex flex-col gap-5">
          ...
          {/* Column 5: Legal */}
          <div className="space-y-8">
            <h4 className="text-syntry-teal-600 font-sans text-[11px] uppercase tracking-[4px] font-medium">Legal</h4>
            <ul className="flex flex-col gap-5">
           ...
           <div className="flex flex-col md:flex-row items-center justify-between w-full pt-12 gap-8">
              ...
              <div className="flex items-center gap-4">
                 <div className="flex gap-1 h-3">
                    ...
                    <div className="w-4 bg-syntry-teal-600"></div>
                 </div>
                 <span className="font-mono text-[9px] tracking-[2px] text-syntry-teal-600 uppercase font-medium tracking-tight">
