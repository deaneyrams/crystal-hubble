  ...
  return (
    <div className="mt-8">
      ...
      <button 
        ...
        className="w-full py-4 bg-gradient-to-r from-indigo-600 to-mint-600 rounded-md font-medium uppercase tracking-widest hover:scale-[1.02] transition-transform shadow-lg shadow-indigo-500/20"
      >
