...
export default function LiquidityPanel({ plotData, onDecompose, isFractionalized }) {
  ...
  return (
    <div className="w-full bg-[#0b132b] border border-indigo-500/30 rounded-2xl shadow-xl shadow-indigo-900/20 p-6 text-gray-200 font-sans">
       <div className="flex justify-between items-center mb-4 border-b border-indigo-500/20 pb-4">
         <h2 className="text-[#FFD700] font-black tracking-widest uppercase text-sm flex items-center gap-2">
       ...
       {!isFractionalized ? (
         <div className="space-y-6">
           <div className="bg-black/40 p-4 rounded-xl border border-white/5 space-y-4">
             <label className="flex flex-col text-[10px] text-gray-400 uppercase tracking-widest font-bold mb-1">
             ...
             <div className="flex flex-col justify-center mt-4 p-3 bg-indigo-900/10 rounded-lg border border-indigo-500/20">
                <div className="text-[10px] uppercase text-gray-500 tracking-widest font-bold mb-2">Real-Time Calculus</div>
                ...
                <div className="text-right mt-1">
                   <span className="text-[9px] uppercase tracking-widest text-[#00F5D4] font-bold">Price per Unit</span>
                </div>
             </div>
           </div>
           ...
           <button
             ...
             className="w-full py-4 text-xs font-black tracking-widest uppercase rounded-xl transition-all shadow-[0_0_20px_rgba(255,215,0,0.3)] bg-gradient-to-r from-yellow-600 to-[#FFD700] hover:scale-[1.02] border border-yellow-400/50 text-black flex justify-center items-center gap-2"
           >
         ...
         <div className="space-y-4 animate-in fade-in zoom-in-95 duration-500">
            <div className="bg-indigo-900/30 border border-indigo-500/50 p-4 rounded-xl text-center shadow-[0_0_15px_rgba(79,70,229,0.2)]">
              <span className="text-indigo-400 text-[11px] uppercase font-black tracking-widest flex items-center justify-center gap-2">
                 <span className="w-2 h-2 rounded-full bg-indigo-400 animate-pulse"></span>
                 STATUS: OPEN FOR MICRO-INVESTMENT
              </span>
            </div>

            <div className="bg-black/50 border border-[#00F5D4]/30 p-4 rounded-xl flex flex-col gap-4 mt-2">
               <div className="flex flex-col flex-grow items-center text-center">
                  <span className="text-[9px] uppercase tracking-widest text-gray-500 font-bold mb-2">Public Marketplace Link</span>
                  ...
                  <button onClick={() => setShowProspectus(true)} className="w-full py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-lg text-[10px] uppercase font-bold tracking-widest transition-colors flex items-center justify-center gap-2 border border-white/10 hover:border-[#00F5D4]/50 hover:text-[#00F5D4]">
