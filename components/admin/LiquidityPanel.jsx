       ...
       {!isFractionalized ? (
         <div className="space-y-6">
           ...
           <button
             ...
             className="w-full py-4 text-xs font-medium tracking-tight tracking-widest uppercase rounded-xl transition-all shadow-[0_0_20px_rgba(255,215,0,0.3)] bg-gradient-to-r from-yellow-600 to-[#FFD700] hover:scale-[1.02] border border-yellow-400/50 text-black flex justify-center items-center gap-2"
           >
