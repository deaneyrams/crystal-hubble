...
export default function InvestorProspectus({ plotData, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
       <div className="bg-[#0b132b] border border-[#00F5D4]/30 w-[800px] max-w-full rounded-md shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
         {/* Header */}
         ...
         <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
               <div className="bg-emerald-900/20 border border-emerald-500/50 p-4 rounded-md flex items-center gap-3">
               ...
               <div>
                 ...
                 <div className="bg-black/50 border border-indigo-500/20 rounded-md p-4 relative h-40 flex items-end">
            ...
            <div className="space-y-6 flex flex-col justify-between">
               <div className="bg-indigo-900/20 border border-indigo-500/30 rounded-md p-6 flex flex-col items-center text-center">
                  ...
                  <div className="bg-white p-3 rounded-md shadow-[0_0_30px_rgba(79,70,229,0.3)] mb-4 w-32 h-32 relative">
                  ...
                  <p className="text-xs uppercase tracking-widest font-medium tracking-tight text-[#00F5D4] bg-[#00F5D4]/10 border border-[#00F5D4]/30 px-4 py-2 rounded-md w-full">
               ...
               <button 
                 ...
                 className={`w-full py-4 text-xs font-medium tracking-tight tracking-widest uppercase rounded-md transition-all shadow-[0_0_15px_rgba(255,255,255,0.1)] flex justify-center items-center gap-2 border break-words
         ...
         {downloading && (
             <div className="absolute inset-0 z-50 bg-[#0E1629] animate-in fade-in zoom-in-95 duration-300 flex flex-col items-center justify-center p-8">
                     ...
                     <div className="p-8 flex-grow flex flex-col bg-[#f8fafc]">
                         ...
                         <div className="flex-grow space-y-6 text-gray-800">
                             ...
                             <div>
                                 ...
                                 <div className="h-28 w-full bg-white border border-gray-200 rounded-md relative shadow-sm overflow-hidden flex items-end pb-2 px-2">
                                    <svg className="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 100 40">
                                      <defs>
                 ...
                 <div className="absolute inset-0 bg-white/20 backdrop-blur-[2px] z-[60] flex items-center justify-center animate-in fade-in duration-500 delay-500">
                     <div className="bg-indigo-900 border border-indigo-500 px-6 py-4 rounded-md shadow-2xl flex items-center gap-4">
                        <div className="w-6 h-6 border-2 border-t-[#00F5D4] border-indigo-500 rounded-md animate-spin"></div>
