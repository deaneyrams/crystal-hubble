      ...
      <main className="pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <section className="mb-20">
          ...
          <div className="max-w-3xl space-y-4">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white border border-[#0F172A]/5 rounded-2xl overflow-hidden shadow-sm">
                <button 
                  onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  className="w-full p-6 text-left flex justify-between items-center transition-colors hover:bg-[#0F172A]/5"
                >
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 items-stretch">
          <div className="bg-[#0F172A] text-[#F8F1E3] p-10 rounded-[2.5rem] shadow-xl border border-[#D4AF37]/20 flex flex-col justify-between">
            <div>
            ...
            <a href="https://wa.me/233531102292" className="bg-[#25D366] text-white py-5 px-8 rounded-2xl font-medium text-center hover:scale-105 transition-all text-sm">
              Chat on WhatsApp ↗
            </a>
          </div>
        ...
        <section className="bg-white/50 border border-[#D4AF37]/20 p-12 rounded-[3rem] text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/dashboard/requests" className="bg-[#0F172A] text-[#F8F1E3] px-8 py-4 rounded-xl font-medium text-xs hover:bg-[#004d00] transition-all">
              Track My Request
            </a>
            <a href="/dashboard/pre-approval" className="bg-[#D4AF37] text-[#0F172A] px-8 py-4 rounded-xl font-medium text-xs hover:scale-105 transition-all">
              Download Pre-Approval
            </a>
            <button className="border border-[#0F172A]/20 text-[#0F172A] px-8 py-4 rounded-xl font-medium text-xs hover:bg-[#0F172A]/5 transition-all">
              Reset Password
            </button>
          </div>
        </section>
