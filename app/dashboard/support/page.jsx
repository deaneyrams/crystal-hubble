    ...
    <div className="bg-[#F8F1E3] min-h-screen text-[#0F172A] font-sans">
      ...
      <main className="pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <section className="text-center mb-20">
          <h1 className="text-4xl md:text-6xl font-medium mb-8 tracking-tight">How Can We Help You?</h1>
          <div className="max-w-xl mx-auto relative">
            <input 
              type="text" 
              placeholder="Search for answers..."
              className="w-full py-5 px-8 rounded-md border border-[#D4AF37]/30 bg-white shadow-xl focus:ring-2 focus:ring-[#D4AF37] outline-none"
              value={searchQuery}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {categories.map((cat, i) => (
            <div key={i} className="bg-white border border-[#D4AF37]/10 p-8 rounded-md hover:border-[#D4AF37]/40 hover:shadow-lg transition-all cursor-pointer">
        ...
        <section className="mb-20">
          <h2 className="text-2xl font-medium mb-10">Popular Questions</h2>
          <div className="max-w-3xl space-y-4">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white border border-[#0F172A]/5 rounded-md overflow-hidden shadow-sm">
                <button 
                  onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  className="w-full p-6 text-left flex justify-between items-center transition-colors hover:bg-syntry-obsidian/5"
                >
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 items-stretch">
          <div className="bg-syntry-obsidian text-[#F8F1E3] p-10 rounded-[2.5rem] shadow-xl border border-[#D4AF37]/20 flex flex-col justify-between">
            <div>
              <h3 className="text-2xl font-medium mb-4">Direct Support</h3>
              <p className="text-sm opacity-60 mb-8">Speak with an advisor on the ground for immediate assistance.</p>
            </div>
            <a href="https://wa.me/233531102292" className="bg-[#25D366] text-white py-5 px-8 rounded-md font-medium text-center hover:scale-105 transition-all text-sm">
              Chat on WhatsApp ↗
            </a>
          </div>

          <div className="bg-white border border-[#D4AF37]/20 p-10 rounded-[2.5rem] shadow-sm flex flex-col justify-center text-center">
            <p className="text-[10px] font-medium uppercase tracking-widest text-[#D4AF37] mb-2">Email Us</p>
            <h4 className="text-xl font-medium mb-8">info@syntry.co</h4>
            <div className="w-12 h-0.5 bg-[#D4AF37] mx-auto opacity-20"></div>
          </div>

          <div className="bg-white border border-[#D4AF37]/20 p-10 rounded-[2.5rem] shadow-sm flex flex-col justify-center text-center">
            <p className="text-[10px] font-medium uppercase tracking-widest text-[#D4AF37] mb-2">Call Us</p>
            <h4 className="text-xl font-medium mb-8">0531102292</h4>
            <div className="w-12 h-0.5 bg-[#D4AF37] mx-auto opacity-20"></div>
          </div>
        </section>
        ...
        <section className="bg-white/50 border border-[#D4AF37]/20 p-12 rounded-[3rem] text-center">
          <h2 className="text-2xl font-medium mb-10 text-[#0F172A]">Self-Service Tools</h2>
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/dashboard/requests" className="bg-syntry-obsidian text-[#F8F1E3] px-8 py-4 rounded-md font-medium text-xs hover:bg-[#004d00] transition-all">
              Track My Request
            </a>
            <a href="/dashboard/pre-approval" className="bg-[#D4AF37] text-[#0F172A] px-8 py-4 rounded-md font-medium text-xs hover:scale-105 transition-all">
              Download Pre-Approval
            </a>
            <button className="border border-[#0F172A]/20 text-[#0F172A] px-8 py-4 rounded-md font-medium text-xs hover:bg-syntry-obsidian/5 transition-all">
              Reset Password
            </button>
          </div>
        </section>
