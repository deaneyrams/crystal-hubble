    ...
    <div className="bg-[#F8F1E3] min-h-screen text-[#0F172A] font-sans">
      ...
      <main className="pt-32 pb-20 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        <section className="mb-12 flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
          <div className="w-32 h-32 bg-syntry-obsidian text-[#D4AF37] rounded-md flex items-center justify-center text-4xl font-medium border-4 border-[#D4AF37]/20 shadow-xl">
            KA
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white border border-[#D4AF37]/20 p-8 rounded-md shadow-sm">
            ...
            <div className="space-y-4">
              {documents.map((doc, i) => (
                <div key={i} className="flex justify-between items-center p-3 bg-[#F8F1E3]/50 rounded-md border border-[#0F172A]/5">
                  <div>
                    <p className="text-xs font-medium mb-1">{doc.name}</p>
                    <p className="text-[10px] opacity-40 font-medium uppercase">Exp: {doc.expiry}</p>
                  </div>
                  <span className="text-[9px] font-medium bg-[#1D9E75]/10 text-[#1D9E75] px-2 py-1 rounded-md uppercase tracking-tighter">
                    {doc.status}
                  </span>
                </div>
              ))}
        ...
        <div className="bg-syntry-obsidian text-[#F8F1E3] p-10 rounded-[3rem] border border-[#D4AF37]/20 shadow-2xl mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <div className="w-10 h-5 bg-[#D4AF37] rounded-md relative">
                  <div className="absolute right-1 top-1 w-3 h-3 bg-syntry-obsidian rounded-md"></div>
                </div>
              </div>
              <div className="flex justify-between items-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-20">
           <a href="https://wa.me/233531102292" className="flex-1 bg-[#25D366] text-white p-6 rounded-md font-medium flex items-center justify-center gap-4 hover:scale-[1.02] transition-all">
             Chat with Support Advisor
           </a>
           <button className="flex-1 border-2 border-[#D4AF37] text-[#0F172A] p-6 rounded-md font-medium flex items-center justify-center gap-4 hover:bg-[#D4AF37]/5 transition-all">
