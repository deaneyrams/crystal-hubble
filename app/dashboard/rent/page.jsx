    ...
    <div className="bg-[#fdfcf9] min-h-screen text-[#0F172A] font-sans">
      ...
      <main className="pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
        <header className="mb-12 border-b border-[#0F172A]/5 pb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          ...
          <button className="bg-syntry-obsidian text-white px-8 py-4 rounded-md font-medium text-xs uppercase tracking-widest hover:scale-[1.02] transition-all shadow-xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {kpis.map((kpi, i) => (
             <div key={i} className="bg-white border border-[#D4AF37]/10 p-8 rounded-md shadow-sm hover:border-[#D4AF37]/40 transition-all flex flex-col justify-between">
        ...
        <section className="bg-white border border-[#0F172A]/5 p-8 rounded-[2.5rem] mb-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-sm">
           ...
           <div className="flex items-center gap-4 bg-syntry-obsidian/5 px-6 py-3 rounded-md">
              <span className="text-[10px] font-medium uppercase tracking-widest opacity-40">Auto-Reminders</span>
              <div className="w-12 h-6 bg-[#1D9E75] rounded-md p-1 cursor-pointer">
                 <div className="w-4 h-4 bg-white rounded-md ml-auto shadow-sm"></div>
              </div>
           </div>
        </section>
        ...
        <section className="mb-20">
          ...
          <div className="space-y-4">
             {rentHistory.map((item) => (
                <div key={item.id} className="bg-white border border-[#0F172A]/5 p-8 rounded-md flex flex-col md:flex-row items-center justify-between gap-8 shadow-sm group hover:border-[#D4AF37]/20 transition-all">
                   <div className="flex gap-6 items-center w-full md:w-1/3">
                      <div className="w-12 h-12 bg-syntry-obsidian/5 rounded-md flex items-center justify-center text-xl">🏠</div>
                      <div>
                   ...
                   <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-end">
                      <span className={`text-[9px] font-medium uppercase px-4 py-1.5 rounded-md border ${
        ...
        <section className="bg-red-50/50 border border-red-100 p-10 rounded-[3rem] text-center">
           ...
           <button className="bg-red-500 text-white px-10 py-4 rounded-md font-medium text-xs uppercase tracking-widest hover:bg-red-600 transition-all shadow-lg">
