    ...
    <div className="bg-[#fdfcf9] min-h-screen text-[#0F172A] font-sans">
      ...
      <main className="pt-32 pb-20 px-4 md:px-8 max-w-6xl mx-auto">
        <header className="mb-12">
          <h1 className="text-4xl font-medium mb-4 tracking-tight">Transaction History</h1>
        ...
        {/* Filters */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-10 pb-6 border-b border-[#0F172A]/5">
        ...
        <div className="space-y-4">
          {filteredHistory.length > 0 ? (
            ...
            <div className="py-32 text-center">
              ...
              <h3 className="text-xl font-medium opacity-40 mb-2">No transactions matching this filter.</h3>
              <p className="text-xs opacity-60 mb-8">Start by checking your buying power or expressing interest.</p>
              <a href="/marketplace" className="text-[#00BFFF] font-medium uppercase text-[10px] tracking-[3px] hover:underline">Explore Marketplace</a>
            </div>
          )}
        </div>
      </main>
