    ...
    <div className="bg-slate-50 min-h-screen text-slate-900 font-sans">
      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <section className="bg-white rounded-[3rem] p-10 md:p-16 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] border border-slate-200 relative overflow-hidden mb-16 text-center isolate">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-syntry-teal-600/5 rounded-md blur-[80px] pointer-events-none -mr-40 -mt-40 -z-10"></div>
            
            <div className="absolute -top-10 -left-10 -rotate-12 opacity-[0.03] pointer-events-none -z-10">
                <div className="border-[16px] border-[#0D9488] text-syntry-teal-600 text-[140px] font-medium tracking-tight uppercase inline-block p-8 leading-none tracking-tighter">PRE-APPROVED</div>
            </div>

            <div className="inline-flex items-center gap-2.5 bg-syntry-teal-600/10 border border-[#0D9488]/20 text-slate-900 px-6 py-2.5 rounded-md text-[11px] font-medium uppercase tracking-widest mb-10 shadow-sm">
                <span className="w-2.5 h-2.5 bg-syntry-teal-600 rounded-md shadow-[0_0_8px_#0D9488] animate-pulse"></span> 8-Layer Verified • Pre-Approved
            </div>
            ...
            <h2 className="text-xl md:text-2xl text-syntry-teal-600 font-medium tracking-tight mb-10 uppercase tracking-[0.15em] border-b-2 border-slate-100 pb-6 inline-block">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
           ...
           <div className="lg:col-span-2 space-y-6">
              <h3 className="text-2xl font-medium tracking-tight text-slate-900 tracking-tight flex items-center gap-3">
                 <span className="w-8 h-8 rounded-lg bg-syntry-teal-600/10 text-syntry-teal-600 flex items-center justify-center border border-[#0D9488]/20 text-lg shadow-sm">📑</span>
                 Facility Summary
              </h3>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                 {/* Approved Amount */}
                 <div className="bg-white p-8 rounded-md border border-slate-200 shadow-sm flex items-center justify-between group hover:border-[#0D9488]/50 hover:shadow-[0_10px_30px_-15px_rgba(0,0,0,0.05)] transition-all duration-300">
                    <div>
                        <p className="text-[11px] font-medium uppercase tracking-widest text-slate-400 mb-2">Approved Amount</p>
                        <p className="text-4xl font-medium tracking-tight text-syntry-teal-600 tracking-tighter">GH₵1,250,000</p>
                    </div>
                    <div className="w-14 h-14 bg-slate-50 rounded-md flex items-center justify-center text-3xl group-hover:scale-110 group-hover:bg-syntry-teal-600/5 transition-all duration-300 shrink-0 border border-slate-100 shadow-sm">💰</div>
                 </div>

                 {/* Estimated Rate & Tenure Array */}
                 <div className="grid grid-rows-2 gap-5">
                    <div className="bg-white p-6 rounded-md border border-slate-200 shadow-sm flex items-center justify-between group hover:border-[#0D9488]/50 hover:shadow-md transition-all duration-300">
                       <div>
                       ...
                       <div className="w-12 h-12 bg-slate-50 rounded-[1rem] flex items-center justify-center text-2xl group-hover:scale-110 group-hover:bg-syntry-teal-600/5 border border-slate-100 transition-all shrink-0">📈</div>
                    </div>
                 ...
                 <div className="bg-white p-6 rounded-md border border-slate-200 shadow-sm flex items-center justify-between group hover:border-[#0D9488]/50 hover:shadow-md transition-all duration-300">
                    ...
                    <div className="w-12 h-12 bg-slate-50 rounded-[1rem] flex items-center justify-center text-xl font-medium tracking-tight group-hover:scale-110 group-hover:text-syntry-teal-600 border border-slate-100 transition-all shrink-0 text-slate-400">⚖️</div>
                 </div>
           ...
           <div className="lg:col-span-1 bg-slate-900 rounded-[3rem] p-8 md:p-10 text-white shadow-2xl relative overflow-hidden flex flex-col group transition-all mt-14 lg:mt-0 lg:ml-4">
              <div className="absolute top-0 right-0 w-48 h-48 bg-syntry-teal-600/10 rounded-md blur-3xl pointer-events-none -mr-10 -mt-10"></div>
              
              <h3 className="text-xl font-medium tracking-tight mb-6 tracking-tight relative z-10 flex flex-col">
                 <span className="text-[10px] uppercase font-medium text-syntry-teal-600 tracking-widest mb-2 bg-syntry-teal-600/10 px-3 py-1.5 inline-block rounded-md w-max border border-[#0D9488]/30 shadow-[0_0_15px_rgba(0,200,83,0.2)]">Sovereign Protocol</span>
                 ...
                 {[
                   ...
                   "Sovereign Audit Issued"
                    ...
                    <li key={idx} className="flex items-center justify-between border-b border-slate-800 pb-3 group-hover:border-slate-700 transition-colors">
                       ...
                       <span className="bg-syntry-teal-600/20 text-syntry-teal-600 text-[9px] font-medium uppercase px-2.5 py-1 rounded-md border border-[#0D9488]/30 tracking-widest flex items-center gap-1.5 shadow-sm"><span className="w-1.5 h-1.5 bg-syntry-teal-600 rounded-md"></span> PASSED</span>
                    </li>
                 ))}
              </ul>

              <div className="mt-8 pt-6 border-t border-slate-800 relative z-10 flex items-start gap-4">
                 <div className="mt-1 w-6 h-6 bg-syntry-teal-600/20 rounded flex items-center justify-center shrink-0 border border-[#0D9488]/30 text-syntry-teal-600 text-xs font-medium tracking-tight">✓</div>
        ...
        <div className="bg-white p-8 md:p-20 rounded-md shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-200 max-w-3xl mx-auto relative overflow-hidden mb-16">
          {/* Embossed Seal Placeholder */}
          <div className="absolute top-12 right-12 w-24 h-24 border-4 border-slate-100 bg-slate-50 rounded-md flex items-center justify-center rotate-12 opacity-50 shadow-inner">
            <div className="text-center">
              <p className="text-[8px] font-medium tracking-tight text-slate-400 uppercase leading-none">Syntry</p>
              <p className="text-[10px] font-medium tracking-tight text-syntry-teal-600 uppercase leading-none mt-1">Verified</p>
          ...
          <div className="flex justify-between items-start mb-20 border-b-2 border-slate-800 pb-8">
            <div>
              <div className="flex items-center gap-0 mb-2">
                <span className="font-medium tracking-tight text-3xl tracking-tighter uppercase text-syntry-teal-600">SYN</span>
          ...
          <div className="space-y-8 text-[15px] text-slate-700 leading-loose mb-20 font-medium">
            <div className="space-y-1 text-sm bg-slate-50 p-6 rounded-md border border-slate-200 inline-block w-full sm:w-auto mt-4">
            ...
            <p>
              We are pleased to inform you that following a comprehensive 8-Layer verification audit of your credentials and financial history, you have been <strong className="text-slate-900 bg-syntry-teal-600/10 px-1 rounded">Pre-Approved</strong> for a mortgage facility through the Syntry Sovereign Exchange.
            </p>

            <div className="bg-slate-50 p-8 rounded-md border border-slate-200 border-l-4 border-l-[#0D9488] space-y-4 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-y-6">
                <div>
                  ...
                  <p className="text-xl font-medium tracking-tight text-syntry-teal-600">GH₵1,250,000</p>
                </div>
                <div>
            ...
            <div className="pt-12 border-t border-slate-100">
              ...
              <div className="mt-4 flex items-center gap-4">
                ...
                <div className="text-[9px] bg-syntry-teal-600 text-white px-2 py-1 rounded-md font-medium uppercase tracking-widest shadow-sm">Signed</div>
              </div>
            </div>
          </div>
        ...
        <section className="mt-32 border-t border-slate-200 pt-20">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              <div className="bg-white p-10 rounded-[3rem] shadow-[0_15px_40px_-15px_rgba(0,0,0,0.05)] border border-slate-200 flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-300">
                 <div className="w-20 h-20 bg-slate-50 border border-slate-100 rounded-md flex items-center justify-center text-3xl font-medium tracking-tight mb-8 text-syntry-teal-600 shadow-sm tracking-tighter">1</div>
              ...
              <div className="bg-white p-10 rounded-[3rem] shadow-[0_15px_40px_-15px_rgba(0,0,0,0.05)] border border-slate-200 flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-300">
                 <div className="w-20 h-20 bg-slate-50 border border-slate-100 rounded-md flex items-center justify-center text-3xl font-medium tracking-tight mb-8 text-syntry-teal-600 shadow-sm tracking-tighter">2</div>
              ...
              <div className="bg-slate-900 p-10 rounded-[3rem] shadow-2xl border border-slate-800 flex flex-col items-center text-center text-white relative overflow-hidden group hover:-translate-y-2 transition-all duration-300 isolate">
                 <div className="absolute top-0 right-0 w-32 h-32 bg-syntry-teal-600/20 blur-3xl pointer-events-none -z-10"></div>
                 <div className="w-20 h-20 bg-syntry-teal-600 text-white rounded-md flex items-center justify-center text-3xl font-medium tracking-tight mb-8 shadow-[0_0_20px_rgba(0,200,83,0.5)] tracking-tighter relative z-10 border-4 border-slate-800">3</div>
           ...
           <div className="flex flex-col md:flex-row gap-5 justify-center mb-32 border-b border-slate-200 pb-20">
              <a href="/marketplace" className="w-full md:w-auto bg-syntry-teal-600 text-white px-10 py-5 rounded-md font-medium text-lg hover:bg-[#0F766E] hover:-translate-y-1 transition-all text-center flex items-center justify-center shadow-[0_15px_30px_-10px_rgba(0,200,83,0.5)] border border-[#0D9488]">
                 Browse Mortgage-Ready Properties
              </a>
              <button className="w-full md:w-auto bg-white border-2 border-slate-200 text-slate-700 px-10 py-5 rounded-md font-medium text-sm hover:bg-slate-50 hover:border-slate-300 transition-all text-center flex items-center justify-center shadow-sm">
              ...
              <button className="w-full md:w-auto bg-slate-900 border-2 border-slate-900 text-white px-10 py-5 rounded-md font-medium text-sm hover:bg-slate-800 transition-all text-center flex items-center justify-center shadow-[0_10px_20px_-10px_rgba(0,0,0,0.5)]">
           ...
           <div className="bg-white max-w-2xl mx-auto rounded-[3rem] p-10 md:p-16 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] border border-slate-200 mb-16 relative overflow-hidden text-center isolate">
              <div className="absolute -top-32 -left-32 w-64 h-64 bg-syntry-teal-600/10 rounded-md blur-3xl pointer-events-none -z-10"></div>
              
              <div className="w-16 h-16 bg-slate-50 rounded-md flex items-center justify-center text-3xl mx-auto mb-8 shadow-sm border border-slate-100">🤔</div>
              <h3 className="text-3xl font-medium tracking-tight mb-10 text-slate-900 tracking-tight">Need help choosing a property?</h3>
              
              {formSubmitted ? (
                 <div className="bg-syntry-teal-600/10 border border-[#0D9488]/30 text-slate-900 p-8 rounded-md text-center relative z-10 shadow-sm">
                    <p className="font-medium tracking-tight text-xl mb-2 flex items-center justify-center gap-2">Message Sent! <span className="text-syntry-teal-600 text-2xl">✓</span></p>
                 ...
                 <form onSubmit={handleFormSubmit} className="space-y-5 max-w-md mx-auto relative z-10">
                    <input type="text" required placeholder="Your full name" className="w-full bg-slate-50 border border-slate-200 rounded-md px-6 py-5 font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#0D9488] focus:border-transparent transition-all placeholder-slate-400" />
                    <input type="tel" required placeholder="Your WhatsApp number" className="w-full bg-slate-50 border border-slate-200 rounded-md px-6 py-5 font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#0D9488] focus:border-transparent transition-all placeholder-slate-400" />
                    <button type="submit" className="w-full bg-slate-900 text-white px-6 py-5 rounded-md font-medium tracking-tight tracking-widest text-[13px] uppercase hover:bg-slate-800 hover:-translate-y-1 transition-all shadow-[0_10px_20px_-10px_rgba(0,0,0,0.5)] mt-2 border border-slate-800">
           ...
           <div className="text-center text-[10px] font-medium uppercase tracking-widest pb-10 text-slate-400 flex items-center justify-center gap-2">
              Digitally Authenticated by Syntry Mortgage Team <span className="w-1 h-1 bg-slate-300 rounded-md mx-1"></span> © 2026 Syntry.co
           </div>
        </section>
      </main>
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 z-[3000] bg-[#25D366] text-white py-3.5 px-6 rounded-md shadow-[0_15px_30px_-5px_rgba(37,211,102,0.4)] hover:scale-105 hover:shadow-[0_20px_40px_-5px_rgba(37,211,102,0.5)] transition-all flex items-center gap-3 border border-[#25D366]"
        title="Talk to Mortgage Team - 053 110 2292"
      >
        <div className="relative">
           <span className="text-2xl pt-1 inline-block">💬</span>
           <span className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-red-500 rounded-md border border-white animate-pulse"></span>
        </div>
