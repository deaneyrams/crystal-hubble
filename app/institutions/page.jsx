    ...
    <div className="bg-white min-h-screen text-slate-900 font-sans">
      ...
      <main className="pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 md:mt-10 mb-16">
           <div className="mb-10">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight leading-tight tracking-tight text-slate-900 mb-4 flex items-center gap-4">
              ...
              <h2 className="text-lg md:text-xl text-slate-500 font-medium">
                 Live <span className="font-medium text-slate-800">8-Layer Verification Intelligence</span> for Banks & Institutions
              </h2>
           </div>
                    ...
                    <div className="bg-slate-800 border border-slate-700 rounded-md p-6">
                       <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                          <div>
                             ...
                             <p className="text-2xl font-medium tracking-tight text-white">{pendingDocs[selectedDoc].aiMatch}</p>
                          </div>
                          <div>
        ...
        <section className="bg-slate-50 border-y border-slate-200 py-24 mb-32">
           <div className="max-w-4xl mx-auto px-4 text-center">
              <h2 className="text-4xl font-medium tracking-tight text-slate-900 mb-4 italic">Query the Sovereign Oracle.</h2>
