    ...
    <div className="min-h-screen bg-[#F8F1E3] text-[#0F172A] selection:bg-[#D4AF37] selection:text-[#0F172A] font-sans pb-32 overflow-x-hidden relative">
      ...
      <section className="max-w-7xl mx-auto px-6 relative mt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, i) => (
            <div 
              key={i}
              className="bg-white border border-[#0F172A]/10 rounded-[2.5rem] p-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all group overflow-hidden relative flex flex-col h-full"
            >
              ...
              <h3 className="text-xl font-medium text-[#0F172A] mb-4 tracking-tight leading-tight group-hover:text-[#D4AF37] transition-colors">{step.title}</h3>
              
              <p className="text-[#0F172A]/70 font-medium leading-relaxed mb-8 flex-grow">{step.desc}</p>
              
              <div className="mt-auto pt-6 border-t border-[#0F172A]/10">
                <p className="text-[11px] font-medium uppercase tracking-widest text-[#D4AF37] mb-1">Investor Benefit</p>
                <p className="text-sm font-semibold text-[#0F172A] leading-snug">{step.benefit}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 mt-40 relative">
         <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-medium mb-6 text-[#0F172A] italic tracking-tight">Real Success Stories</h2>
            <p className="text-xl md:text-2xl opacity-80 max-w-2xl mx-auto font-medium text-[#0F172A]">Real Ghanaians & Diaspora investors who now own with confidence.</p>
         </div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="bg-white rounded-[2.5rem] p-10 shadow-xl border border-[#0F172A]/10 flex flex-col group hover:-translate-y-2 transition-transform duration-300">
               ...
               <div className="grid grid-cols-3 gap-2 border-t border-[#0F172A]/10 pt-6">
                  <div className="text-center">
                     <p className="text-[10px] uppercase font-medium text-[#D4AF37] mb-1">Time</p>
                     <p className="font-medium text-[#1D9E75]">14 Days</p>
                  </div>
                  <div className="text-center border-x border-[#0F172A]/5">
                     <p className="text-[10px] uppercase font-medium text-[#D4AF37] mb-1">Approved</p>
                     <p className="font-medium text-[#1D9E75]">GH₵1.8M</p>
                  </div>
                  <div className="text-center">
                     <p className="text-[10px] uppercase font-medium text-[#D4AF37] mb-1">Risk</p>
                     <p className="font-medium text-[#1D9E75]">0.00%</p>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-syntry-obsidian rounded-[2.5rem] p-10 shadow-2xl border border-[#D4AF37]/20 flex flex-col group hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden">
               ...
               <div className="grid grid-cols-3 gap-2 border-t border-white/10 pt-6 relative z-10">
                  <div className="text-center">
                     <p className="text-[10px] uppercase font-medium text-white/50 mb-1">Rent</p>
                     <p className="font-medium text-[#A8E6CF]">GH₵4.2k</p>
                  </div>
                  <div className="text-center border-x border-white/10">
                     <p className="text-[10px] uppercase font-medium text-white/50 mb-1">Yield</p>
                     <p className="font-medium text-[#A8E6CF]">3.8% APY</p>
                  </div>
                  <div className="text-center">
                     <p className="text-[10px] uppercase font-medium text-white/50 mb-1">System</p>
                     <p className="font-medium text-[#A8E6CF]">Automated</p>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-white rounded-[2.5rem] p-10 shadow-xl border border-[#0F172A]/10 flex flex-col group hover:-translate-y-2 transition-transform duration-300">
               ...
               <div className="grid grid-cols-3 gap-2 border-t border-[#0F172A]/10 pt-6">
                  <div className="text-center">
                     <p className="text-[10px] uppercase font-medium text-[#D4AF37] mb-1">Time</p>
                     <p className="font-medium text-[#1D9E75]">9 Days</p>
                  </div>
                  <div className="text-center border-x border-[#0F172A]/5">
                     <p className="text-[10px] uppercase font-medium text-[#D4AF37] mb-1">Raised</p>
                     <p className="font-medium text-[#1D9E75]">GH₵2.4M</p>
                  </div>
                  <div className="text-center">
                     <p className="text-[10px] uppercase font-medium text-[#D4AF37] mb-1">Disputes</p>
                     <p className="font-medium text-[#1D9E75]">Zero</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section className="max-w-4xl mx-auto px-6 mt-32 relative text-center">
        <h2 className="text-3xl md:text-5xl font-medium mb-6 text-[#0F172A] italic tracking-tight">Ready to own property with total confidence?</h2>
        ...
        <div className="bg-white rounded-[3rem] p-10 md:p-16 shadow-2xl border border-[#0F172A]/10 text-left relative overflow-hidden mb-16 max-w-2xl mx-auto">
           ...
           {formSubmitted ? (
             ...
             <form onSubmit={handleFormSubmit} className="space-y-6 relative z-10 text-[#0F172A]">
                ...
                <p className="text-center text-[10px] uppercase tracking-widest text-[#0F172A]/40 font-medium mt-4 flex items-center justify-center gap-2">
