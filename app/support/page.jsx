  ...
  return (
    <div className="bg-[#F8F1E3] min-h-screen text-[#003300] font-sans">
      ...
      <main className="pt-40 pb-20 px-6 max-w-4xl mx-auto">
        <h1 className="text-5xl font-black italic mb-10 tracking-tight">Support Center</h1>
        
        <div className="space-y-6">
          {faqs.map((faq, i) => (
            <div key={i} className="bg-white border-2 border-[#003300]/5 rounded-[2rem] overflow-hidden shadow-sm">
              <button 
        ...
        <div className="mt-20 bg-[#003300] text-[#D4AF37] p-12 rounded-[3rem] text-center shadow-2xl">
          ...
          <a href="https://wa.me/233531102292" className="bg-[#D4AF37] text-[#003300] px-10 py-5 rounded-2xl font-black text-lg hover:scale-105 transition-all inline-block shadow-xl">
