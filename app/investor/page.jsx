       ...
       <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
          ...
          <header className="flex justify-between items-end border-b border-white/10 pb-6">
             <div>
                <h1 className="text-3xl font-light tracking-wide flex items-center gap-3">
                   Syntry <span className="font-black text-[#00F5D4]">Member Portal</span>
                </h1>
             ...
             <div className="text-right">
                <div className="flex items-center justify-end gap-2 mb-1">
                   ...
                   <span className="text-[10px] text-emerald-400 uppercase font-black tracking-widest">Global Escrow Active</span>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             ...
             <div className="bg-[#0b132b] p-6 rounded-2xl border border-indigo-500/20 shadow-[0_0_20px_rgba(79,70,229,0.05)] col-span-2">
                <h2 className="text-[10px] uppercase font-black text-indigo-400 tracking-widest mb-6">Yield Projection Matrix (12% CAGR)</h2>
                
                <div className="flex items-end justify-between px-4 pb-4">
                   <div className="text-center">
                      <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest mb-2">2026 (Entry)</p>
                      <div className="w-16 h-16 bg-white/5 border-b-2 border-indigo-500/30 rounded-t-sm flex items-end justify-center pb-2 transition-all duration-500 hover:h-20 hover:bg-indigo-500/10">
                         <span className="text-xs font-mono text-gray-300 font-bold">${currentPrice.toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits:0})}</span>
                      </div>
                   </div>
                   
                   <div className="text-center">
                      <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest mb-2">2027 (Year 1)</p>
                      <div className="w-16 h-24 bg-white/5 border-b-2 border-indigo-400/50 rounded-t-sm flex items-end justify-center pb-2 transition-all duration-500 hover:h-28 hover:bg-indigo-400/10">
                         <span className="text-xs font-mono text-indigo-300 font-bold">${y1.toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits:0})}</span>
                      </div>
                   </div>

                   <div className="text-center">
                      <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest mb-2">2028 (Year 2)</p>
                      <div className="w-16 h-32 bg-white/5 border-b-2 border-indigo-300/70 rounded-t-sm flex items-end justify-center pb-2 transition-all duration-500 hover:h-36 hover:bg-indigo-300/10">
                         <span className="text-xs font-mono text-indigo-200 font-bold">${y2.toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits:0})}</span>
                      </div>
                   </div>

                   <div className="text-center">
                      <p className="text-[10px] text-[#00F5D4] uppercase font-black tracking-widest mb-2">2029 (Target)</p>
                      <div className="w-16 h-44 bg-gradient-to-t from-indigo-900/40 to-[#00F5D4]/10 border-b-4 border-[#00F5D4] rounded-t-sm flex items-end justify-center pb-3 transition-all duration-500 hover:h-48 shadow-[0_0_15px_rgba(0,245,212,0.1)] hover:shadow-[0_0_25px_rgba(0,245,212,0.3)]">
                         <span className="text-sm font-mono text-[#00F5D4] font-black drop-shadow-md">${y3.toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits:0})}</span>
                      </div>
                   </div>
                </div>
             ...
             <div className="bg-[#0b132b] p-6 rounded-2xl border border-white/5 flex flex-col justify-between">
                <div>
                   <h3 className="text-[10px] uppercase font-black text-gray-400 tracking-widest mb-4">Total Packets Sold</h3>
          ...
          <div className="bg-[#0b132b] rounded-2xl border border-white/5 overflow-hidden">
             <div className="p-6 border-b border-white/5 flex justify-between items-center bg-black/20">
                <h2 className="text-[10px] uppercase font-black text-gray-400 tracking-widest">Public Dividend Ledger (Partial Sync)</h2>
                <span className="text-[9px] uppercase font-bold text-indigo-400 border border-indigo-500/30 bg-indigo-900/20 px-2 py-1 rounded">50 Node Accounts Online</span>
             </div>
             <div className="overflow-x-auto">
                <table className="w-full text-left">
                   <thead>
                      <tr className="border-b border-white/5 text-[9px] uppercase tracking-widest text-gray-500 font-bold bg-black/40">
                   ...
                   <tbody>
                      ...
                      <tr>
                         <td colSpan="5" className="p-4 text-center">
                            <span className="text-[10px] uppercase tracking-widest text-gray-600 font-bold animate-pulse">And 40 anonymous node holders...</span>
                         </td>
                      </tr>
                   </tbody>
                </table>
