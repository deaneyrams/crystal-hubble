...
export default function VerifyLandNowPage() {
  ...
  if (!hasMounted) return <div className="bg-[#0F172A] min-h-screen" />;

  return (
    <div className="bg-[#0F172A] min-h-screen text-slate-50 font-sans flex flex-col overflow-x-hidden">
      <GlobalHeader />
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-[3rem] border border-white/10 overflow-hidden shadow-2xl">
             ...
             <div className="p-8 md:p-12 lg:p-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="space-y-4">
                    <div className="w-full h-[500px] bg-white/5 rounded-[2.5rem] overflow-hidden shadow-inner border-2 border-white/10 relative group">
                       <SovereignMap 
                 ...
                 <div className="bg-white/5 backdrop-blur-xl border-t-[12px] border-[#0D9488] border-x border-b border-white/10 rounded-[4rem] overflow-hidden shadow-2xl">
                    <div className="p-8 md:p-16 border-b border-white/10 flex flex-col lg:flex-row justify-between gap-12 bg-black/20 font-sans">
                       <div className="space-y-6">
                          <div className="flex items-center gap-4">
                             ...
                             <div>
                                ...
                                <p className="text-slate-400 font-medium">Asset ID: SYN-GA-4052 • Accra Registry</p>
                             </div>
                          </div>
                       ...
                       <div className="flex flex-col gap-3 justify-center items-center lg:items-end">
                          ...
                          <p className="text-5xl font-medium tracking-tight text-slate-50 tracking-tighter">GH₵ 3.25M</p>
