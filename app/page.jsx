...
export default function SyntryHomepage() {
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans selection:bg-[#00C853] selection:text-white">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              <Link href="/" className="text-2xl font-black tracking-tighter text-slate-900 flex items-center gap-2">
                <div className="w-8 h-8 rounded bg-[#00C853] flex items-center justify-center">
            ...
            <div className="hidden md:flex space-x-8">
              <Link href="/marketplace" className="text-sm font-semibold text-slate-600 hover:text-[#00C853] transition-colors">Marketplace</Link>
              <Link href="/how-it-works" className="text-sm font-semibold text-slate-600 hover:text-[#00C853] transition-colors">How It Works</Link>
              <Link href="/owners" className="text-sm font-semibold text-slate-600 hover:text-[#00C853] transition-colors">For Owners</Link>
              <Link href="/diaspora" className="text-sm font-semibold text-slate-600 hover:text-[#00C853] transition-colors">For Diaspora</Link>
              <Link href="/institutions" className="text-sm font-semibold text-slate-600 hover:text-[#00C853] transition-colors">Institutions</Link>
              <Link href="/pricing" className="text-sm font-semibold text-slate-600 hover:text-[#00C853] transition-colors">Pricing</Link>
            </div>
            <div className="flex items-center space-x-4">
              <Link href="/login" className="hidden md:inline-flex text-sm font-bold text-slate-700 hover:text-slate-900">Login</Link>
              <Link href="/register" className="bg-[#00C853] hover:bg-[#00A040] text-white px-5 py-2.5 rounded-lg text-sm font-bold transition-transform hover:scale-105 shadow-lg shadow-green-500/20">
                Get Started
              </Link>
            </div>
          </div>
      ...
      <section className="relative pt-20 pb-32 overflow-hidden bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-slate-900 mb-6 leading-tight">
            ...
            <span className="text-[#00C853]">With Total Confidence.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/marketplace" className="bg-[#00C853] hover:bg-[#00A040] text-white px-8 py-4 rounded-xl text-lg font-bold transition-all shadow-xl shadow-green-500/30 hover:-translate-y-1">
              Browse Verified Properties
            </Link>
            <Link href="/verify-land-now" className="bg-white border-2 border-slate-200 hover:border-slate-300 text-slate-800 px-8 py-4 rounded-xl text-lg font-bold transition-all shadow-sm hover:-translate-y-1">
              Check My Property Free
            </Link>
          </div>
          
          <div className="mt-16 pt-8 border-t border-slate-100 flex flex-wrap justify-center items-center gap-8 text-sm font-bold text-slate-500">
            <span className="flex items-center gap-2">
              <svg className="w-5 h-5 text-[#00C853]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
              0.00% Litigation
            </span>
            <span className="flex items-center gap-2">
              <svg className="w-5 h-5 text-[#00C853]" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" /></svg>
              Trusted by Diaspora & Local Investors
            </span>
            <span className="flex items-center gap-2">
              <svg className="w-5 h-5 text-[#00C853]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" /></svg>
      ...
      <section className="py-24 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">The Syntry Standard: 8 Layers of Truth</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-16 h-16 bg-[#00C853]/5 rounded-bl-full -z-0 group-hover:scale-150 transition-transform"></div>
                <div className="w-10 h-10 bg-[#00C853]/10 text-[#00C853] rounded-lg flex items-center justify-center font-black text-xl mb-4 relative z-10">
                  {i + 1}
                </div>
                <h3 className="text-lg font-bold text-slate-900 mb-2 relative z-10">{layer.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6">Why High-Net-Worth Individuals Choose Syntry</h2>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#00C853]/10 rounded-xl flex items-center justify-center text-[#00C853]">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                  </div>
                  <div>
                    <h4 className="text-xl font-bold text-slate-900">Bank-Grade Escrow Engine</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-slate-900">100% Diaspora Friendly</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-slate-900">Automated Yield Generation</h4>
            ...
            <div className="lg:w-1/2">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-slate-900/90 to-transparent p-8 pt-32">
                  <div className="bg-[#00C853] text-white text-xs font-bold px-3 py-1 rounded-full inline-block mb-3 uppercase tracking-wider">Fully Verified</div>
                  <h3 className="text-white text-2xl font-bold">Cantonments Luxury Villas</h3>
      ...
      <section className="py-24 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl font-black text-slate-900">Featured Verified Assets</h2>
              <p className="text-slate-600 mt-2">Premium properties cleared by the Syntry Protocol.</p>
            </div>
            <Link href="/marketplace" className="hidden sm:inline-flex items-center gap-2 text-[#00C853] font-bold hover:text-[#00A040]">
            ...
            {[
              ...
              <div key={i} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all group">
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 bg-white/90 backdrop-blur text-slate-900 text-xs font-bold px-3 py-1.5 rounded-lg flex items-center gap-1 shadow-sm">
                    <svg className="w-4 h-4 text-[#00C853]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                    Syntry Verified
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center mb-6">
                    <span className="text-2xl font-black text-[#00C853]">{prop.price}</span>
                  ...
                  <div className="flex justify-between items-center border-t border-slate-100 pt-4">
                    ...
                    <button className="text-slate-900 font-bold hover:text-[#00C853] text-sm">View Asset &rarr;</button>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-black text-slate-900 mb-16">Trusted by the Global Diaspora</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#00C853]/10"></div>
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Ready to Build Your African Portfolio?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/register" className="bg-[#00C853] hover:bg-[#00A040] text-white px-8 py-4 rounded-xl text-lg font-bold transition-all shadow-xl hover:-translate-y-1">
              Create Free Account
            </Link>
            <Link href="/owners" className="bg-white/10 hover:bg-white/20 text-white border border-white/30 px-8 py-4 rounded-xl text-lg font-bold transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/marketplace" className="hover:text-[#00C853]">Marketplace</Link></li>
                <li><Link href="/how-it-works" className="hover:text-[#00C853]">How It Works</Link></li>
                <li><Link href="/pricing" className="hover:text-[#00C853]">Pricing</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-bold mb-4">Solutions</h4>
              <ul className="space-y-2 text-sm">
                <li><Link href="/diaspora" className="hover:text-[#00C853]">For Diaspora</Link></li>
                <li><Link href="/owners" className="hover:text-[#00C853]">For Owners</Link></li>
                <li><Link href="/institutions" className="hover:text-[#00C853]">For Institutions</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-bold mb-4">Legal</h4>
              <ul className="space-y-2 text-sm">
                <li><Link href="/privacy" className="hover:text-[#00C853]">Privacy Policy</Link></li>
                <li><Link href="/terms" className="hover:text-[#00C853]">Terms of Service</Link></li>
                <li><Link href="/security" className="hover:text-[#00C853]">Security Protocol</Link></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
            ...
            <div className="flex gap-4 mt-4 md:mt-0">
              <span className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-[#00C853]"></div> System Operational</span>
            </div>
          </div>
        </div>
      </footer>
