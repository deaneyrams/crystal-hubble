    ...
    <div className="bg-syntry-obsidian min-h-screen text-white font-sans">
      ...
      <main className="pt-40 pb-20 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-24">
          <h1 className="text-6xl md:text-[8rem] font-medium tracking-tight italic tracking-tighter leading-none mb-8">Join the <span className="text-syntry-teal-600">Sovereign.</span></h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {jobs.map((job, i) => (
            <div key={i} className="bg-white/5 border border-white/10 p-10 rounded-[2.5rem] hover:border-[#0D9488]/40 hover:bg-syntry-teal-600/5 transition-all group">
              <div className="text-[10px] font-medium tracking-tight uppercase tracking-widest text-syntry-teal-600 mb-4">{job.type} • {job.loc}</div>
              ...
              <button onClick={() => alert('Sending application interest to careers@syntry.co')} className="w-full bg-white text-black py-4 rounded-md font-medium hover:bg-syntry-teal-600 hover:text-white transition-all shadow-lg">
                Apply Now
              </button>
            </div>
          ))}
        ...
        <div className="mt-32 border-t border-white/5 pt-20 text-center">
          ...
          <a href="mailto:careers@syntry.co" className="text-syntry-teal-600 text-xl font-medium underline underline-offset-[10px] hover:text-white transition-colors">
