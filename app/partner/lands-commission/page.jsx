  ...
  return (
    <div className="bg-[#fdfcf9] min-h-screen text-[#0F172A] font-sans">
      ...
      <main className="pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
           <div className="md:col-span-2 bg-white border border-[#D4AF37]/20 p-10 rounded-md shadow-sm">
              ...
              <div className="space-y-6">
                 <div className="flex justify-between border-b pb-4 border-[#0F172A]/5">
        ...
        <section className="bg-white border border-[#0F172A]/10 p-10 md:p-16 rounded-[2.5rem] shadow-sm flex flex-col md:flex-row items-center justify-between gap-12">
           <div className="max-w-xl">
             <h2 className="text-2xl font-medium mb-4">Request Institutional Access</h2>
