    ...
    <div className="bg-[#F8F1E3] min-h-screen text-[#0F172A] font-sans">
      ...
      <main className="pt-32 pb-20 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        <header className="mb-12 text-center">
          <h1 className="text-4xl font-medium tracking-tight mb-8">Upload New Property</h1>
        ...
        {/* Step 1: Basic Info */}
        {step === 1 && (
          <div className="bg-white border border-[#0F172A]/5 p-8 md:p-12 rounded-[3rem] shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
             <div className="space-y-8">
                ...
                <div>
                   <label className="text-[10px] font-medium uppercase tracking-[2px] opacity-40 block mb-3">Property Photos</label>
                   <div className="border-2 border-dashed border-[#0F172A]/10 rounded-[2rem] p-12 text-center hover:border-[#D4AF37]/40 transition-all group pointer-cursor">
                      <p className="text-3xl mb-4 group-hover:scale-110 transition-transform">📸</p>
                      <p className="text-xs font-medium opacity-60">Drag and drop high-res photos here</p>
        ...
        {step === 2 && (
          <div className="bg-white border border-[#0F172A]/5 p-8 md:p-12 rounded-[3rem] shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
             <h3 className="text-xl font-medium mb-8 italic text-[#0F172A]">8 Layers Statutory Documents</h3>
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={idx} className="bg-[#0F172A]/5 p-6 rounded-2xl border border-dashed border-[#0F172A]/10 flex items-center justify-between group hover:border-[#D4AF37]/40 transition-all cursor-pointer">
                    ...
                    <span className="text-xs font-medium text-[#D4AF37]">Upload</span>
                  </div>
                ))}
             </div>
          </div>
        ...
        {step === 3 && (
          <div className="bg-white border border-[#D4AF37]/20 p-8 md:p-12 rounded-[3.5rem] shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
             <h3 className="text-2xl font-medium mb-8 italic text-[#0F172A]">Review & Statutory Submit</h3>
        ...
        <div className="mt-12 flex flex-col md:flex-row items-center justify-between gap-6">
           <p className="text-[10px] font-medium opacity-40 italic max-w-xs text-center md:text-left">
