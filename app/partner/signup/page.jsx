    ...
    <div className="bg-[#fdfcf9] min-h-screen text-[#0F172A] font-sans">
      ...
      <main className="pt-32 pb-20 px-4 md:px-8 max-w-6xl mx-auto">
        ...
        <section className="mb-20 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-medium mb-6 tracking-tight">Join as a Developer or Agent</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
           {/* Form Section */}
           <div className="bg-white border border-[#0F172A]/5 p-10 md:p-16 rounded-[3rem] shadow-sm">
              <h3 className="text-2xl font-medium mb-10">Create Your Professional Account</h3>
           ...
           <div className="flex flex-col justify-center space-y-12">
              {[
                ...
                <div key={i} className="flex gap-8 group">
                   ...
                   <div>
                      <h4 className="font-medium text-lg mb-2">{benefit.t}</h4>
