          ...
          <div className="flex border-b border-white/5">
            {['listings', 'leads', 'analytics'].map(tab => (
              <button 
                ...
                className={`px-10 py-6 text-[10px] font-head font-medium tracking-tight uppercase tracking-[4px] transition-all ${
                ...
                <div key={listing.id} className="bg-black/20 border border-white/5 rounded-md p-6 flex flex-col md:flex-row justify-between items-center gap-6 hover:border-white/20 transition-all group">
                  ...
                  <div className="flex items-center gap-12 w-full md:w-auto justify-between">
                     <div className="text-center">
                        ...
                        <p className="font-head font-medium tracking-tight text-white">{listing.views}</p>
                     </div>
                     <div className="text-center">
