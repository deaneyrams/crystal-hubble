  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-[#0D1B2A] text-white flex flex-col items-center justify-center p-6 text-center">
        ...
        >
          <div className="w-20 h-20 bg-[#B8FF3C]/10 rounded-md flex items-center justify-center text-4xl mx-auto mb-8 border border-[#B8FF3C]/30">🛡️</div>
          ...
          <a href="/partner/dashboard" className="px-10 py-4 bg-[#B8FF3C] text-black font-head font-medium tracking-tight uppercase tracking-widest text-xs rounded-md shadow-xl hover:scale-105 transition-all">
        ...
        <div className="bg-[#162A3E]/50 border border-white/10 p-8 md:p-12 rounded-[40px] backdrop-blur-xl">
          <AnimatePresence mode="wait">
              ...
              <motion.div key="s1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" placeholder="GHA-XXXXXXXXX-X" className="w-full bg-black/40 border border-white/10 rounded-md py-4 px-6 text-white focus:border-[#B8FF3C] outline-none font-mono" />
                  </div>
                  <div className="border-2 border-dashed border-white/10 rounded-md p-10 text-center hover:border-[#B8FF3C]/30 transition-all cursor-pointer">
              ...
              <motion.div key="s2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" placeholder="Emerald Grove" className="w-full bg-black/40 border border-white/10 rounded-md py-4 px-6 text-white focus:border-[#B8FF3C] outline-none font-mono" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-mono uppercase tracking-widest text-white/40">Location</label>
                    <input type="text" placeholder="Pokuase, Accra" className="w-full bg-black/40 border border-white/10 rounded-md py-4 px-6 text-white focus:border-[#B8FF3C] outline-none font-mono" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-mono uppercase tracking-widest text-white/40">Price (GHS)</label>
                    <input type="number" placeholder="85000" className="w-full bg-black/40 border border-white/10 rounded-md py-4 px-6 text-white focus:border-[#B8FF3C] outline-none font-mono" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-mono uppercase tracking-widest text-white/40">Plot Size</label>
                    <input type="text" placeholder="70x100ft" className="w-full bg-black/40 border border-white/10 rounded-md py-4 px-6 text-white focus:border-[#B8FF3C] outline-none font-mono" />
                  </div>
                </div>
                <div className="border-2 border-dashed border-white/10 rounded-md p-10 text-center hover:border-[#B8FF3C]/30 transition-all cursor-pointer">
            ...
            {step === 3 && (
              <motion.div key="s3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                ...
                <div className="bg-black/40 border border-white/10 p-8 rounded-md space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button className="py-4 border border-white/10 rounded-md text-[10px] font-mono uppercase tracking-[2px] hover:bg-white/5">Stripe</button>
                  <button className="py-4 border border-[#B8FF3C]/30 rounded-md text-[10px] font-mono uppercase tracking-[2px] bg-[#B8FF3C]/10 text-[#B8FF3C]">Paystack</button>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <div className="mt-12 flex justify-between">
            ...
            <button 
              ...
              className="px-10 py-4 bg-[#B8FF3C] text-black font-head font-medium tracking-tight uppercase tracking-[4px] text-[10px] rounded-md hover:scale-105 active:scale-95 transition-all flex items-center justify-center min-w-[150px]"
            >
              {isSubmitting ? (
                <span className="w-4 h-4 border-2 border-black/20 border-t-black rounded-md animate-spin"></span>
              ) : (
