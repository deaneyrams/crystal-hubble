    ...
    <div className="bg-[#F8F1E3] min-h-screen text-[#0F172A] font-sans">
      ...
      <main className="pt-40 pb-20 px-6 max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-medium tracking-tight mb-4 italic">Confirm Your <span className="text-[#D4AF37]">Upgrade.</span></h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          {/* Order Summary */}
          <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl border border-[#0F172A]/5">
            ...
            <div className="space-y-6 mb-10">
              <div className="flex justify-between items-center bg-[#F8F1E3]/50 p-6 rounded-md border border-[#0F172A]/5">
                ...
                <p className="font-medium text-xl">GH₵ 2,800</p>
              </div>
            ...
            <div className="pt-8 border-t border-[#0F172A]/10">
               <div className="flex justify-between items-center mb-10">
                  <span className="text-xl font-medium italic">Total Due Today</span>
                  <span className="text-3xl font-medium tracking-tight text-[#0F172A]">GH₵ 2,800.00</span>
               </div>
               
               <p className="text-[9px] font-medium uppercase tracking-[0.2em] text-[#0F172A]/30 text-center">
          ...
          <div className="space-y-8">
            <h3 className="text-xl font-medium mb-2 uppercase tracking-widest opacity-40">Settlement Method</h3>
