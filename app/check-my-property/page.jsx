             ...
             <div className="flex border-b border-slate-100 bg-slate-50/50">
                {[
                  ...
                  <button 
                    ...
                    className={`flex-1 py-6 px-4 flex items-center justify-center gap-3 text-xs font-medium tracking-tight uppercase tracking-widest transition-all ${activeTab === tab.id ? 'bg-white text-slate-900 border-b-4 border-[#0D9488]' : 'text-slate-400 hover:text-slate-600'}`}
                  >
        ...
        {showResults && (
           <div id="results-dashboard" className="py-24 animate-in fade-in slide-in-from-bottom-12 duration-1000">
              <div className="max-w-6xl mx-auto px-4">
                 <div className="bg-white border-t-[12px] border-[#0D9488] border-x border-b border-slate-200 rounded-[4rem] overflow-hidden shadow-2xl">
                           ...
                           {geometryVerified && (
                              <div className="bg-[#D4AF37]/10 border border-[#D4AF37]/30 p-6 rounded-3xl flex items-center gap-4 animate-in fade-in slide-in-from-left-4 duration-500 delay-300 mt-6">
                                 ...
                                 <div>
                                    ...
                                    <p className="text-xs font-medium text-slate-600">Map calculated area matched AI scanned documents within a 2% margin. Absolute boundary sync achieved.</p>
                                 </div>
                              </div>
                           )}
                       </div>
                    ...
                    <div className="p-8 md:p-16 grid grid-cols-1 lg:grid-cols-12 gap-16">
                       ...
                       <div className="lg:col-span-8 space-y-10 font-sans">
                          <h3 className="text-xs font-medium tracking-tight text-slate-400 uppercase tracking-[3px] border-b pb-4">Sovereign 8-Layer Matrix</h3>
      ...
      {activeLayer && (
         <div className="fixed inset-0 z-[3000] flex items-center justify-center p-6 bg-slate-900/60 backdrop-blur-sm animate-in fade-in font-sans">
            <div className="bg-white w-full max-w-lg rounded-[3rem] p-12 shadow-3xl relative animate-in zoom-in-95">
               <button onClick={() => setActiveLayer(null)} className="absolute top-8 right-8 text-slate-400 hover:text-slate-900 text-2xl font-medium tracking-tight transition-all">✕</button>
               <div className="space-y-8">
