    ...
    <div className="bg-syntry-obsidian min-h-screen text-white font-sans">
      ...
      <main className="pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <section className="mb-20 text-center md:text-left">
          <div className="inline-flex items-center gap-2 bg-syntry-teal/10 text-syntry-teal px-4 py-2 rounded-full mb-6 border border-syntry-teal/20">
            <span className="w-2 h-2 bg-syntry-teal rounded-full animate-pulse"></span>
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl inline-block text-left shadow-lg backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          {prefabHomes.map((home) => (
            <div key={home.id} className="bg-white/5 rounded-3xl overflow-hidden border border-white/10 group hover:border-syntry-teal/50 shadow-sm hover:shadow-xl transition-all">
              ...
              <div className="p-10">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="bg-syntry-teal text-white text-[10px] font-medium px-3 py-1 rounded-full uppercase">
                    Mortgage Ready
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button className="bg-white/10 text-white py-4 rounded-xl font-medium text-xs hover:bg-white/20 transition-all">
                    View Floorplan
                  </button>
                  <button className="bg-syntry-teal text-white py-4 rounded-xl font-medium text-xs hover:scale-105 transition-all">
                    Connect Mortgage
                  </button>
                </div>
              </div>
        ...
        <section className="bg-syntry-teal/5 border border-syntry-teal/20 p-12 md:p-20 rounded-[3rem] relative overflow-hidden text-center md:text-left">
          <div className="absolute top-0 right-0 w-96 h-96 bg-syntry-teal/5 rounded-full blur-3xl -mr-48 -mt-48"></div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex gap-4">
                    <span className="w-6 h-6 bg-syntry-teal text-white rounded-full flex items-center justify-center shrink-0 font-medium text-xs">✓</span>
                    <div>
            ...
            <div className="grid grid-cols-2 gap-4">
               <button className="col-span-2 bg-syntry-teal text-white p-6 rounded-2xl font-medium text-xl hover:scale-105 transition-all shadow-lg">
                 Request Prefab Catalog
               </button>
               <a href="https://wa.me/233531102292" className="col-span-2 bg-[#25D366] text-white p-6 rounded-2xl font-medium text-xl hover:scale-105 transition-all flex items-center justify-center gap-4 shadow-lg">
