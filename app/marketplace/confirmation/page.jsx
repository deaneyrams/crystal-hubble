    ...
    <div className="bg-[#F8F1E3] min-h-screen text-[#0F172A] font-sans">
      ...
      <main className="pt-40 pb-20 px-4 md:px-8 max-w-4xl mx-auto text-center">
        ...
        <div className="bg-white border border-[#D4AF37]/20 p-6 rounded-2xl shadow-sm mb-12 flex flex-col md:flex-row items-center gap-6 text-left max-w-2xl mx-auto">
          <div className="w-24 h-20 bg-[#0F172A]/5 rounded-xl flex items-center justify-center text-[8px] opacity-40 italic">
            [Property Photo]
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 text-left">
          <div className="space-y-3">
            <div className="w-8 h-8 bg-[#0F172A] text-[#F8F1E3] rounded-full flex items-center justify-center font-medium text-sm">1</div>
          ...
          <div className="space-y-3">
            <div className="w-8 h-8 bg-[#0F172A] text-[#F8F1E3] rounded-full flex items-center justify-center font-medium text-sm">2</div>
          ...
          <div className="space-y-3">
            <div className="w-8 h-8 bg-[#0F172A] text-[#F8F1E3] rounded-full flex items-center justify-center font-medium text-sm">3</div>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <a href="/dashboard/requests" className="bg-[#0F172A] text-[#F8F1E3] px-10 py-4 rounded-xl font-medium text-sm hover:bg-[#004d00] transition-all">
            Track My Requests
          </a>
          <a href="/marketplace" className="border border-[#0F172A]/20 px-10 py-4 rounded-xl font-medium text-sm hover:bg-[#0F172A]/5 transition-all">
            Browse More Properties
          </a>
          <a href="https://wa.me/233531102292" target="_blank" rel="noreferrer" className="bg-[#25D366] text-white px-10 py-4 rounded-xl font-medium text-sm hover:scale-105 transition-all flex items-center justify-center gap-2">
            Chat with Advisor
          </a>
        </div>
      </main>
