  ...
  return (
    <div className="bg-[#F8F1E3] min-h-screen text-[#003300] font-sans">
      ...
      <main className="pt-32 pb-20 overflow-hidden">
        ...
        <section className="px-4 md:px-8 max-w-7xl mx-auto mb-32 pt-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left z-10 relative">
            <div className="inline-flex items-center gap-3 bg-[#1D9E75]/10 px-5 py-2.5 rounded-full mb-8 border border-[#1D9E75]/20 shadow-sm backdrop-blur-sm">
              ...
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#1D9E75]">Diaspora Sovereign Hub</span>
            </div>
            ...
            <h2 className="text-sm md:text-base font-bold text-[#1D9E75] uppercase tracking-widest flex flex-col md:flex-row flex-wrap items-center justify-center lg:justify-start gap-2 md:gap-3 leading-relaxed mb-6">
              ...
              <span>24/7 Remote Control</span> <span className="hidden md:block text-[#003300]/20">•</span>
            ...
            <div className="flex flex-col xl:flex-row items-center justify-center lg:justify-start gap-4 mb-10 w-full max-w-xl mx-auto lg:mx-0">
               <a href="/diaspora/signup" className="w-full bg-[#1D9E75] text-white px-8 py-5 rounded-2xl font-bold text-lg hover:bg-[#157a5a] transition-all shadow-xl shadow-[#1D9E75]/30 flex items-center justify-center gap-3">
                 <span className="text-xl">🌍</span> Register as Diaspora Now – Free
               </a>
               <a href="/check-my-property" className="w-full bg-white border border-[#003300]/20 text-[#003300] px-8 py-5 rounded-2xl font-bold text-lg hover:border-[#1D9E75] hover:text-[#1D9E75] hover:bg-[#1D9E75]/5 transition-all shadow-sm flex items-center justify-center gap-2">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 p-5 bg-white rounded-2xl border border-[#003300]/10 max-w-fit mx-auto lg:mx-0 shadow-sm">
              <div className="flex -space-x-3">
                <div className="w-10 h-10 rounded-full bg-[#003300] border-2 border-white flex items-center justify-center text-xs shadow-sm shadow-[#003300]/20">🇬🇧</div>
              ...
              <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#003300]/60 leading-relaxed text-center sm:text-left">
                ...
                <span className="text-[#003300]">UK • USA • Canada • Germany</span>
              </p>
            </div>
          </div>
             ...
             <div className="w-full h-[600px] border-[12px] border-white bg-white rounded-[4rem] shadow-2xl overflow-hidden p-4 relative group">
                ...
                <div className="w-full h-full bg-[#003300] rounded-[3.5rem] flex flex-col p-10 overflow-hidden relative transition-transform duration-700">
                   ...
                   <div className="flex justify-between items-center mb-12 relative z-20">
                      <div className="text-[10px] font-bold text-[#D4AF37] uppercase tracking-[0.2em] bg-[#D4AF37]/10 px-3 py-1.5 rounded-full border border-[#D4AF37]/20">Global Node: Active</div>
                   ...
                   <div className="space-y-6 relative z-20">
                      <div className="bg-white/5 border border-white/10 p-8 rounded-[2rem] backdrop-blur-sm relative overflow-hidden group-hover:border-[#D4AF37]/30 transition-colors">
                         ...
                         <p className="text-[9px] font-bold text-[#F8F1E3]/50 uppercase tracking-[0.2em] mb-2 flex items-center gap-2">Live Valuation (Ghana Indexed) <span className="w-2 h-2 rounded-full bg-[#1D9E75]"></span></p>
                         <h3 className="text-4xl font-bold text-white tracking-tight italic">GH₵8,450,000</h3>
                      </div>
                      <div className="space-y-3 pl-2 border-l-2 border-[#1D9E75]/30">
                         <p className="text-[9px] font-bold text-[#1D9E75] uppercase tracking-widest pl-2">Recent Automated Inflows</p>
                         <div className="bg-[#1D9E75]/10 border border-[#1D9E75]/20 px-6 py-5 rounded-2xl flex justify-between items-center text-[10px] font-bold backdrop-blur-sm ml-2">
                   ...
                   <div className="mt-auto relative z-20 h-40 bg-[#000]/20 rounded-[2.5rem] border border-white/5 flex items-center justify-center overflow-hidden">
                      ...
                      <div className="text-center">
                        ...
                        <span className="text-white/40 font-bold uppercase tracking-widest text-[10px] italic relative z-10 bg-[#003300]/80 px-4 py-1.5 rounded-full">Secure GPS Lock Active</span>
                      </div>
                   </div>
                </div>
             </div>
        ...
        <section className="bg-[#003300] relative overflow-hidden py-32 px-4 md:px-8 mb-32 z-10">
           ...
           <div className="max-w-7xl mx-auto relative z-20">
              <div className="text-center mb-20">
                 <div className="inline-flex items-center gap-2 bg-[#D4AF37]/10 px-4 py-2 rounded-full mb-6 border border-[#D4AF37]/20">
                   <span className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#D4AF37]">The Syntry Standard</span>
                 </div>
                 <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 italic text-[#F8F1E3] tracking-tight">Empowering Diaspora Ownership</h2>
        ...
        <section className="px-4 md:px-8 max-w-7xl mx-auto mb-40 relative">
           ...
           <div className="text-center mb-20 relative z-10">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 italic tracking-tight text-[#003300]">Real Diaspora Stories</h2>
              <p className="text-lg md:text-xl font-bold text-[#D4AF37] uppercase tracking-widest bg-[#D4AF37]/10 inline-block px-6 py-2 rounded-full border border-[#D4AF37]/20">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-24 relative z-10">
              {[
                ...
                <div key={i} className="flex flex-col text-center bg-white p-10 md:p-12 rounded-[3.5rem] border border-[#003300]/10 shadow-[0_30px_60px_-15px_rgba(0,51,0,0.05)] hover:-translate-y-3 transition-transform duration-500 relative flex-grow h-full">
                   ...
                   <div className="w-24 h-24 bg-[#003300] text-[#D4AF37] rounded-[2.5rem] mx-auto flex items-center justify-center text-5xl mb-10 shadow-xl shadow-[#003300]/20 border-[6px] border-[#F8F1E3] relative z-10">{t.photo}</div>
                   <p className="text-xl md:text-2xl font-bold italic opacity-90 mb-12 leading-relaxed text-[#003300] flex-grow relative z-10">"{t.quote}"</p>
                   <div className="pt-8 border-t border-[#003300]/10 bg-[#F8F1E3]/50 -mx-10 md:-mx-12 -mb-10 md:-mb-12 p-8 md:p-10 rounded-b-[3.5rem] mt-auto">
                      <h4 className="font-black text-[#003300] text-3xl tracking-tight mb-3">{t.name}</h4>
                      <p className="text-xs font-bold uppercase tracking-widest text-[#1D9E75] flex items-center justify-center gap-3">
                         <span className="text-xl bg-white w-10 h-10 rounded-[1rem] shadow-sm flex items-center justify-center border border-[#003300]/5">{t.flag}</span>
                         {t.loc}
                      </p>
                   </div>
                </div>
           ...
           <div className="relative z-10 max-w-5xl mx-auto transform translate-y-4">
              <div className="bg-[#003300] text-white p-2 border-[12px] border-white rounded-[4rem] shadow-2xl flex flex-col lg:flex-row items-stretch divide-y lg:divide-y-0 lg:divide-x divide-white/10 relative overflow-hidden group">
                 ...
                 <div className="flex-1 p-8 md:p-12 text-center lg:text-left flex flex-col justify-center relative z-10">
                    <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4AF37] mb-4 flex items-center justify-center lg:justify-start gap-2">
                       <span className="text-lg">🛡️</span> Total Asset Value
                    </p>
                    <p className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight leading-tight">
                 ...
                 <div className="flex-1 p-8 md:p-12 lg:text-right flex flex-col justify-center bg-white/5 rounded-[3rem] lg:rounded-l-none relative z-10">
                    <div className="flex gap-2 items-center justify-center lg:justify-end mb-4">
                       ...
                       <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#1D9E75]">Live Protocol Network</p>
                    </div>
                    <p className="text-lg md:text-2xl font-medium opacity-90 italic text-center lg:text-right">
                       ...
                       <strong className="text-[#A8E6CF] text-2xl md:text-3xl font-bold not-italic">GH₵4,200</strong> to Aburi Owner in UK
                    </p>
                 </div>
              </div>
              ...
              <div className="text-center mt-16 md:mt-20">
                 <a href="/diaspora/signup" className="inline-flex items-center justify-center gap-4 bg-[#D4AF37] text-[#003300] px-10 md:px-16 py-6 md:py-8 rounded-[3rem] font-black text-xl md:text-3xl hover:scale-[1.02] transition-all shadow-[0_30px_60px_-15px_rgba(212,175,55,0.5)] group tracking-tight">
        ...
        <section className="px-4 md:px-8 max-w-7xl mx-auto mb-40 relative">
           <h2 className="text-4xl md:text-5xl font-bold mb-16 text-center italic tracking-tight text-[#003300]">Global Control in 4 Clean Steps</h2>
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={i} className="bg-white p-10 rounded-[2.5rem] border border-[#003300]/10 shadow-[0_20px_40px_-20px_rgba(0,51,0,0.05)] hover:-translate-y-2 transition-transform duration-500 group relative overflow-hidden text-center flex flex-col h-full h-full">
                   ...
                   <div className="text-8xl text-[#003300]/5 font-black absolute -top-6 -right-6 pointer-events-none group-hover:text-[#D4AF37]/10 transition-colors duration-500 z-0">{step.s}</div>
                   <div className="w-16 h-16 bg-[#F8F1E3] text-[#003300] rounded-2xl mx-auto flex items-center justify-center text-3xl mb-8 group-hover:bg-[#1D9E75] group-hover:text-white transition-colors duration-500 shadow-sm relative z-10">{step.icon}</div>
                   <h4 className="font-black text-2xl mb-4 tracking-tight leading-tight text-[#003300] relative z-10">{step.t}</h4>
           ...
           <div className="bg-white p-8 md:p-16 rounded-[3.5rem] md:rounded-[4rem] text-center shadow-[0_40px_80px_-20px_rgba(0,51,0,0.1)] relative overflow-hidden border-[8px] md:border-[16px] border-[#F8F1E3]">
              ...
              <div className="relative z-10 max-w-2xl mx-auto mb-16 pt-4">
                 <div className="inline-flex items-center gap-2 bg-[#1D9E75]/10 px-4 py-2 rounded-full mb-6 border border-[#1D9E75]/20">
                   ...
                   <span className="text-[10px] font-bold uppercase tracking-widest text-[#1D9E75]">Global Verification Node</span>
                 </div>
                 
                 <h2 className="text-3xl md:text-5xl font-bold mb-6 italic tracking-tight text-[#003300]">Start Your Free Diaspora <br className="hidden md:block"/> Verification Today</h2>
                 ...
                 <form className="space-y-6 text-left" onSubmit={(e) => { e.preventDefault(); alert('Lead Sent to Syntry Command Center.'); }}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                       <div>
                          ...
                          <input type="text" required placeholder="Kwame Osei" className="w-full bg-[#F8F1E3]/50 border border-[#003300]/10 rounded-2xl px-6 py-5 focus:outline-none focus:border-[#1D9E75] focus:ring-2 focus:ring-[#1D9E75]/30 transition-all font-medium text-sm" />
                       </div>
                       <div>
                          <label className="block text-[10px] font-bold uppercase tracking-widest text-[#003300]/70 mb-2 pl-3">WhatsApp / Phone (Intl)</label>
                          <input type="tel" required placeholder="+44 7700 900077" className="w-full bg-[#F8F1E3]/50 border border-[#003300]/10 rounded-2xl px-6 py-5 focus:outline-none focus:border-[#1D9E75] focus:ring-2 focus:ring-[#1D9E75]/30 transition-all font-medium text-sm" />
                       </div>
                    </div>
                    <div>
                       <label className="block text-[10px] font-bold uppercase tracking-widest text-[#003300]/70 mb-2 pl-3">Property Location / Title Number</label>
                       <input type="text" placeholder="e.g. Plot 42, Aburi or Title #GA-1234" className="w-full bg-[#F8F1E3]/50 border border-[#003300]/10 rounded-2xl px-6 py-5 focus:outline-none focus:border-[#1D9E75] focus:ring-2 focus:ring-[#1D9E75]/30 transition-all font-medium text-sm" />
                    </div>
                    <div>
                       <label className="block text-[10px] font-bold uppercase tracking-widest text-[#003300]/70 mb-2 pl-3">Email Address (Optional)</label>
                       <input type="email" placeholder="kwame@example.com" className="w-full bg-[#F8F1E3]/50 border border-[#003300]/10 rounded-2xl px-6 py-5 focus:outline-none focus:border-[#1D9E75] focus:ring-2 focus:ring-[#1D9E75]/30 transition-all font-medium text-sm" />
                    </div>
                    
                    <button type="submit" className="w-full bg-[#1D9E75] text-white px-8 py-6 rounded-2xl font-black text-xl hover:bg-[#157a5a] transition-all shadow-[0_20px_40px_-10px_rgba(29,158,117,0.4)] mt-8 flex items-center justify-center gap-3 group">
                       Submit for Free 8-Layer Verification Report 
                       <span className="group-hover:translate-x-1 transition-transform">→</span>
                    </button>
                    <p className="text-center text-[10px] font-bold uppercase tracking-widest text-[#003300]/40 mt-5 flex items-center justify-center gap-2">
              ...
              {/* Final Split CTAs */}
              <div className="pt-10 md:pt-12 border-t border-[#003300]/5 flex flex-col sm:flex-row gap-4 md:gap-6 items-center justify-center relative z-10 w-full max-w-xl mx-auto">
                 <a href="/marketplace" className="w-full sm:w-auto bg-[#003300] text-[#D4AF37] px-8 py-4.5 rounded-xl font-bold text-sm hover:bg-[#002200] transition-all shadow-lg flex items-center justify-center gap-2 whitespace-nowrap">
                   Browse Verified Properties Now
                 </a>
                 <span className="text-[#003300]/30 font-bold italic hidden sm:block">or</span>
                 <a href="https://wa.me/233531102292" className="w-full sm:w-auto bg-transparent border border-[#003300]/20 text-[#003300] px-8 py-4 rounded-xl font-bold text-sm hover:border-[#1D9E75] hover:text-[#1D9E75] hover:bg-[#1D9E75]/5 transition-all flex items-center justify-center gap-2 whitespace-nowrap">
